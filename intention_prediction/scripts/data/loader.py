...
from intention_prediction.scripts.data.trajectories import JAADDataset, JAADLoader, JAADcollate, LausanneDataset, LausanneLoader, Lausannecollate
...
def data_loader(args, path, dtype):
    ...
    if dtype == "train":
        ...
        dataset = LausanneLoader(df, path, dtype, args.obs_len)
