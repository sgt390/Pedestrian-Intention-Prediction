...
from intention_prediction.scripts.models import CNNLSTM1_SCENES_2 as CNNLSTM  # , CNNMP
...
def step(args, batch, classifier, loss_fn, optimizer):
    (pedestrian_crops, _, _, _, decision_true, _, _, pedestrian_scenes, *_) = batch
    ...
    decision_pred = classifier(pedestrian_crops, pedestrian_scenes)
